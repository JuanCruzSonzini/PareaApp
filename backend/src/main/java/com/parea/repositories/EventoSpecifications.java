...
public class EventoSpecifications {
    ...
    public static Specification<Evento> tituloContiene(String titulo) {
    ...
    public static Specification<Evento> modalidadEs(String modalidad) {
        return (root, query, cb) -> modalidad == null ? null :
                cb.equal(root.get("modalidad"), modalidad);
    }

    public static Specification<Evento> esGratuitoEs(Boolean esGratuito) {
        return (root, query, cb) -> esGratuito == null ? null :
    ...
    public static Specification<Evento> requiereInscripcionEs(Boolean requiereInscripcion) {
        return (root, query, cb) -> requiereInscripcion == null ? null :
